<%-- 
    Document   : formularioAdmin
    Created on : 2/10/2023, 7:18:42 p. m.
    Author     : camil
--%>
...
<html>
    ...
    <body class="miP">
        <jsp:include page="jspf/menu.jspf"></jsp:include>
            <div class="miDiv">
                <center class="miC"><h1 class="nt">Formulario Administrador</h1></center> 
                ...
                <div class=" mit table-responsive ">
                    ...
                    <table border="1" class="table table-hover table-striped table-bordered ">
                        ...
                        <form action="ControladorAdmin" method="post">
                            <td><input type="hidden" name="fIdAdmin" value="${elAdmin.idAdmin}">
                                <input type="text" name="fNombre" value="${elAdmin.nombre}"></td>
                            <td><input type="text" name="fApellido" value="${elAdmin.apellido}"></td>
                            <td><input type="text" name="fCedula" value="${elAdmin.cedula}"></td>
                            <td><input type="text" name="fTelefono" value="${elAdmin.telefono}"></td>
                            <td><input type="email" name="fCorreo" value="${elAdmin.correo}"></td>
                            <td><input type="text" name="fDireccion" value="${elAdmin.direccion}"></td>
