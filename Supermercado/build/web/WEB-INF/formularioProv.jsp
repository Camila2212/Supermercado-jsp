<%-- 
    Document   : formularioProv
    Created on : 4/10/2023, 11:02:03 a. m.
    Author     : camil
--%>
...
<html>
    ...
    <body class="miP">
        ...
        <jsp:include page="jspf/menu.jspf"></jsp:include>
            <div class="miDiv">
                <center class="miC"><h1 class="nt">Formulario Proveedor</h1></center> 
                ...
                <div class=" mit table-responsive ">
                    ...
                    <table border="1" class="table table-hover table-striped table-bordered ">
                        ...
                        <form action="ControladorProv" method="post">
                            <td><input type="hidden" name="fIdProv" value="${elProv.idProv}">
                                <input type="text" name="fNombre" value="${elProv.nombre}"></td>
                            <td><input type="text" name="fNit" value="${elProv.nit}"></td>
                            <td><input type="number" name="fTelefono" value="${elProv.telefono}"></td>
                            <td><input type="email" name="fCorreo" value="${elProv.correo}"></td>
                    ...
                    <tr>
                    <form action="ControladorProv" method="post">
                        <td><input type="hidden" name="fIdProv" value="0">
                            <input type="text" name="fNombre"></td>
                        <td><input type="text" name="fNit"></td>
                        <td><input type="number" name="fTelefono"></td>
